...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '菜单URL', field: 'url', align: 'center', valign: 'middle', sortable: true, width: '250px'},
...
function getMenuId () {
    ...
    var selected = $('#dataGrid').bootstrapTreeTable('getSelections');//getSelectedRow();取选中对象ID
    if (selected.length == 0) {
        alert("请选择一条记录");
        return false;
    } else {
        console.log("menu:"+selected[0].id);
